...
<div class="container-fluid" style="background:  #7dfdce;padding-top: 130px!important;">
            ...
            <div class='p-3 rounded bg-white'>
                <c:forEach items="${items }" var="item">
	                <div class="border-bottom pb-3">
	                    <img class="mr-2 float-left" src="${baseUrl}/${item.product.pic }" width="90" height="90">
	                    <div class="p-2">
        ...
        <div class="col-sm-5">
            <div class='rounded bg-white p-2'>
                ...
                <table class="table">
                    ...
                    <tr>
                        <th>GST @18%</th>
                        <th class="text-right font-weight-bold">&#8377; ${o.totalOrderPrice * 0.18}</th>
                    </tr>
                    <tr>
                        <th>Net Amount</th>
                        <th class="text-right font-weight-bold">&#8377; ${o.totalOrderPrice+o.totalOrderPrice * 0.18}</th>
                    </tr>
                </table>
            </div>
        </div>
